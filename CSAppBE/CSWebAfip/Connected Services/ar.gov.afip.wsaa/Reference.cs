...
namespace CSWebAfip.ar.gov.afip.wsaa {
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="https://wsaa.afip.gov.ar/ws/services/LoginCms", ConfigurationName="ar.gov.afip.wsaa.LoginCMS")]
    public interface LoginCMS {
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(CSWebAfip.ar.gov.afip.wsaa.LoginFault), Action="", Name="fault")]
        CSWebAfip.ar.gov.afip.wsaa.loginCmsResponse loginCms(CSWebAfip.ar.gov.afip.wsaa.loginCmsRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        System.Threading.Tasks.Task<CSWebAfip.ar.gov.afip.wsaa.loginCmsResponse> loginCmsAsync(CSWebAfip.ar.gov.afip.wsaa.loginCmsRequest request);
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface LoginCMSChannel : CSWebAfip.ar.gov.afip.wsaa.LoginCMS, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class LoginCMSClient : System.ServiceModel.ClientBase<CSWebAfip.ar.gov.afip.wsaa.LoginCMS>, CSWebAfip.ar.gov.afip.wsaa.LoginCMS {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        CSWebAfip.ar.gov.afip.wsaa.loginCmsResponse CSWebAfip.ar.gov.afip.wsaa.LoginCMS.loginCms(CSWebAfip.ar.gov.afip.wsaa.loginCmsRequest request) {
            return base.Channel.loginCms(request);
        }
        
        public string loginCms(string in0) {
            CSWebAfip.ar.gov.afip.wsaa.loginCmsRequest inValue = new CSWebAfip.ar.gov.afip.wsaa.loginCmsRequest();
            inValue.in0 = in0;
            CSWebAfip.ar.gov.afip.wsaa.loginCmsResponse retVal = ((CSWebAfip.ar.gov.afip.wsaa.LoginCMS)(this)).loginCms(inValue);
            return retVal.loginCmsReturn;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<CSWebAfip.ar.gov.afip.wsaa.loginCmsResponse> CSWebAfip.ar.gov.afip.wsaa.LoginCMS.loginCmsAsync(CSWebAfip.ar.gov.afip.wsaa.loginCmsRequest request) {
            return base.Channel.loginCmsAsync(request);
        }
        
        public System.Threading.Tasks.Task<CSWebAfip.ar.gov.afip.wsaa.loginCmsResponse> loginCmsAsync(string in0) {
            CSWebAfip.ar.gov.afip.wsaa.loginCmsRequest inValue = new CSWebAfip.ar.gov.afip.wsaa.loginCmsRequest();
            inValue.in0 = in0;
            return ((CSWebAfip.ar.gov.afip.wsaa.LoginCMS)(this)).loginCmsAsync(inValue);
        }
    }
}
