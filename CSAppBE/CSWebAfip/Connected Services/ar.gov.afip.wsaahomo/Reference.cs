...
namespace CSWebAfip.ar.gov.afip.wsaahomo {
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="https://wsaahomo.afip.gov.ar/ws/services/LoginCms", ConfigurationName="ar.gov.afip.wsaahomo.LoginCMS")]
    public interface LoginCMS {
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(CSWebAfip.ar.gov.afip.wsaahomo.LoginFault), Action="", Name="fault")]
        CSWebAfip.ar.gov.afip.wsaahomo.loginCmsResponse loginCms(CSWebAfip.ar.gov.afip.wsaahomo.loginCmsRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        System.Threading.Tasks.Task<CSWebAfip.ar.gov.afip.wsaahomo.loginCmsResponse> loginCmsAsync(CSWebAfip.ar.gov.afip.wsaahomo.loginCmsRequest request);
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface LoginCMSChannel : CSWebAfip.ar.gov.afip.wsaahomo.LoginCMS, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class LoginCMSClient : System.ServiceModel.ClientBase<CSWebAfip.ar.gov.afip.wsaahomo.LoginCMS>, CSWebAfip.ar.gov.afip.wsaahomo.LoginCMS {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        CSWebAfip.ar.gov.afip.wsaahomo.loginCmsResponse CSWebAfip.ar.gov.afip.wsaahomo.LoginCMS.loginCms(CSWebAfip.ar.gov.afip.wsaahomo.loginCmsRequest request) {
            return base.Channel.loginCms(request);
        }
        
        public string loginCms(string in0) {
            CSWebAfip.ar.gov.afip.wsaahomo.loginCmsRequest inValue = new CSWebAfip.ar.gov.afip.wsaahomo.loginCmsRequest();
            inValue.in0 = in0;
            CSWebAfip.ar.gov.afip.wsaahomo.loginCmsResponse retVal = ((CSWebAfip.ar.gov.afip.wsaahomo.LoginCMS)(this)).loginCms(inValue);
            return retVal.loginCmsReturn;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<CSWebAfip.ar.gov.afip.wsaahomo.loginCmsResponse> CSWebAfip.ar.gov.afip.wsaahomo.LoginCMS.loginCmsAsync(CSWebAfip.ar.gov.afip.wsaahomo.loginCmsRequest request) {
            return base.Channel.loginCmsAsync(request);
        }
        
        public System.Threading.Tasks.Task<CSWebAfip.ar.gov.afip.wsaahomo.loginCmsResponse> loginCmsAsync(string in0) {
            CSWebAfip.ar.gov.afip.wsaahomo.loginCmsRequest inValue = new CSWebAfip.ar.gov.afip.wsaahomo.loginCmsRequest();
            inValue.in0 = in0;
            return ((CSWebAfip.ar.gov.afip.wsaahomo.LoginCMS)(this)).loginCmsAsync(inValue);
        }
    }
}
